	...
	<div class="container-xxl position-relative bg-white d-flex p-0">
       ...
       <div class="content">
        ...
        <div class="innerOuter">
            ...
            <form id="enrollForm" method="post" action="adminInrUpdate.bo" enctype="multipart/form-data">
            <input type="hidden" name="inrNo" value="${ i.inrNo }">
                <table algin="center">
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="writer" class="form-control" value="${i.memberId}" name="memberId" readonly></td>
                    </tr>
