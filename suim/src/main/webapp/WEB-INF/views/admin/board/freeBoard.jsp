...
<style>
	#freeBoardList {text-align:center;}
	#freeBoardList>tbody>tr:hover {
		cursor:pointer;
        ...
        <div class="content">
                ...
                <div class="row g-4">
                     ...
                     <div class="col-12">
                        <div class="bg-light rounded h-100 p-4" width="">
                            <h6 class="mb-4">자유게시판 관리</h6>

							<div align="right" class="searchForm">
							<form class="d-md-flex ms-4" action="/adminBoardSearch.bo" method="get">
								<div class="select">
							...
							<ul class="nav nav-tabs">
								<li class="nav-item">
									<a class="nav-link" data-toggle="tab" href="adminBoardList.bo">전체</a>
								</li>
								<li class="nav-item">
									<a class="nav-link" data-toggle="tab" href="adminBoardList.bo?currentPage=1&category=Y">등록</a>
								</li>
								<li class="nav-item">
									<a class="nav-link" data-toggle="tab" href="adminBoardList.bo?currentPage=1&category=N">삭제</a>
								</li>
							</ul>
                            ...
                            <div class="tab-content pt-3" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
									<div class="table-responsive">
										<form action="/adminDelete.bo" method="post" >
		                                <table class="table" id="freeBoardList">
		                                    <thead>
		                                        <tr>
		                                    ...
		                                    <c:choose>
			                                    <c:when test="${ not empty list }">
			                                    	<c:forEach var="b" items="${ list }">
				                    					<tr>
					                                      	<td scope="row"><input class="form-check-input" type="checkbox" name="checkboxName" value="${b.boardNo}"></td>
															...
															<td>
																<a href="/adminUpdateForm.bo?bno=${b.boardNo}">
				...
				<nav id="pagingArea" style="margin-top: 30px; margin-bottom: 30px;">
					<ul class="pagination justify-content-center">
						<li class="page-item ${pi.currentPage == 1 ? 'disabled' : ''}">
							<a class="page-link" href="<c:url value='adminBoardList.bo?currentPage=${pi.currentPage - 1}&category=${category}'/>">&lt;</a>
						</li>
						<c:forEach var="p" begin="${pi.startPage}" end="${pi.endPage}" step="1">
							<li class="page-item ${pi.currentPage == p ? 'active' : ''}">
								<a class="page-link" href="<c:url value='adminBoardList.bo?currentPage=${p}&category=${category}'/>">${p}</a>
							</li>
						</c:forEach>
			...
			<c:if test="${not empty param.keyword}">
				<nav id="pagingArea" style="margin-top: 30px; margin-bottom: 30px;">
					<ul class="pagination justify-content-center">
						<li class="page-item ${pi.currentPage == 1 ? 'disabled' : ''}">
							<a class="page-link" href="<c:url value='adminBoardSearch.bo?currentPage=${pi.currentPage - 1}&category=${category}&keyword=${keyword}&condition=${condition}'/>">&lt;</a>
						</li>
						<c:forEach var="p" begin="${pi.startPage}" end="${pi.endPage}" step="1">
							<li class="page-item ${pi.currentPage == p ? 'active' : ''}">
								<a class="page-link" href="<c:url value='adminBoardSearch.bo?currentPage=${p}&category=${category}&keyword=${keyword}&condition=${condition}'/>">${p}</a>
							</li>
						</c:forEach>
						<li class="page-item ${pi.currentPage == pi.maxPage || pi.listCount == 0 ? 'disabled' : ''}">
							<a class="page-link" href="<c:url value='adminBoardSearch.bo?currentPage=${pi.currentPage + 1}&category=${category}&keyword=${keyword}&condition=${condition}'/>">&gt;</a>
