	...
	<nav class="navbar navbar-expand-lg navbar-light fixed-top header_wrap"
		...
		<div class="header container px-4 px-lg-5">
			...
			<ul class="nav nav-pills navi">
				...
				<li class="nav-item"><a href="#" class="nav-link nav-text">방
						찾기</a></li>
				<li class="nav-item"><a href="#" class="nav-link nav-text">쉼</a>
					<ul>
						<li><a href="">쉼 소개</a></li>
					</ul></li>
				<li class="nav-item"><a href="#" class="nav-link nav-text">커뮤니티</a>
					<ul>
				...
				<c:choose>
					...
					<c:otherwise>
						<li class="nav-item"><a href="#" class="nav-link nav-text">${ loginUser.memberName }님</a>
							<ul>
				...
				<li class="nav-item"><a href="#" class="nav-link nav-text">고객센터</a>
					<ul>
			...
			<div class="offcanvas offcanvas-end" tabindex="-1"
				...
				<div class="offcanvas-header">
					<c:choose>
						<c:when test="${ empty loginUser }">
							<h5 class="offcanvas-title" id="offcanvasNavbarLabel">&nbsp;&nbsp;&nbsp;&nbsp;로그인
								해주세요.</h5>
						</c:when>
					</c:choose>
						...
						<c:choose>
							<c:when test="${not empty loginUser}">
								<li class="nav-item dropdown m-4"><a class="side-black"
									...
									data-bs-toggle="dropdown" aria-expanded="false">${loginUser.memberName}님</a>
