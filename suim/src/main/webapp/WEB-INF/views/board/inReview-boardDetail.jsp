		            ...
		            for (let i = 0; i < result.length; i++) {
		                ...
		                if (result[i].memberId == loginUser) {
		                    resultStr += "<td><button class='btn btn-danger deleteButton' data-id='" + result[i].memberId + "' style='float:right; background-color: rgb(250, 107, 111); font-size: 11px; padding: 4px 8px;'>" +
		                        ...
		                        "</button></td>";
		                    resultStr += "<td><button class='btn btn-secondary updateButton' data-id='" + result[i].memberId + "' data-content='" + result[i].ireContent + "' style='float:right; background-color: #7464a1; font-size: 11px; padding: 4px 8px;'>" +
